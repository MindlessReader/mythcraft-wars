...
$execute if data storage mythcraft:config {skillLocations:{$(skill):{regularPool:["husk"]}}} run data modify storage mythcraft:temp hasHusk set value "true"
$execute if data storage mythcraft:config {skillLocations:{$(skill):{regularPool:["parched"]}}} run data modify storage mythcraft:temp hasParched set value "true"
$execute if data storage mythcraft:config {skillLocations:{$(skill):{regularPool:["stray"]}}} run data modify storage mythcraft:temp hasStray set value "true"
$execute if data storage mythcraft:config {skillLocations:{$(skill):{regularPool:["slime"]}}} run data modify storage mythcraft:temp hasSlime set value "true"
$execute if data storage mythcraft:config {skillLocations:{$(skill):{regularPool:["bogged"]}}} run data modify storage mythcraft:temp hasBogged set value "true"
$execute if data storage mythcraft:config {skillLocations:{$(skill):{regularPool:["piglin"]}}} run data modify storage mythcraft:temp hasPiglin set value "true"
...
$execute if data storage mythcraft:config {skillLocations:{$(skill):{bossPool:["witherskeleton"]}}} run data modify storage mythcraft:temp hasWitherskeleton set value "true"
$execute if data storage mythcraft:config {skillLocations:{$(skill):{bossPool:["evoker"]}}} run data modify storage mythcraft:temp hasEvoker set value "true"
$execute if data storage mythcraft:config {skillLocations:{$(skill):{bossPool:["piglinbrute"]}}} run data modify storage mythcraft:temp hasPiglinbrute set value "true"
$execute if data storage mythcraft:config {skillLocations:{$(skill):{bossPool:["bossslime"]}}} run data modify storage mythcraft:temp hasBossslime set value "true"
