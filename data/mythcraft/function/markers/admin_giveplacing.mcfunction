...
# Raid Boss Spawn Marker
give @s wither_skeleton_spawn_egg[custom_name=[{italic:false,text:"Spawn Marker: "},{bold:true,color:"dark_purple",text:"Raid Boss"}],entity_data={id:"minecraft:marker",Tags:["spawnmarker","spawnmarker_raidboss"]}] 1
#Visual Notif
tellraw @s [{color:"blue",text:"[Mythcraft Wars Admin] Troop spawner markers given. Place regular markers (green) = troopCap count, boss markers (red) = bossCap count, raid boss markers (purple) = 1 per location."}]
