...
item replace entity @s weapon.offhand with shield[unbreakable={},enchantments={"minecraft:vanishing_curse":1},use_cooldown={seconds:0.05,cooldown_group:"mythcraft:shield"}]
