...
#replace hand
item replace entity @s weapon.mainhand with glass_bottle[max_stack_size=1,custom_name='[{"color":"light_purple","italic":false,"text":"Seeking Breath Bottle"},{"color":"gray","italic":false,"text":" [Empty]"}]',lore=['{"color":"gray","italic":false,"text":"On Cooldown","underlined":true}'],hide_additional_tooltip={},custom_data={mythcraft_breathempty:1b}] 1