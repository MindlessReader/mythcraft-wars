function mythcraft:conquer {cityName:Celak, teamId:0, teamName:Unaligned, rewardFunction: celak}
function mythcraft:conquer {cityName:Kings-Port, teamId:0, teamName:Unaligned, rewardFunction: kings-port}
function mythcraft:conquer {cityName:Athens, teamId:0, teamName:Unaligned, rewardFunction: athens}
function mythcraft:conquer {cityName:Delphi, teamId:0, teamName:Unaligned, rewardFunction: delphi}
