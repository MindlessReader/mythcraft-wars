...
$execute if score EntityCount mathCounter = $(cityName) cityConquerValue if score $(cityName) cityOwnership matches 0 run tellraw @a [{"color":"#FFD700","bold":false,"text":"Unaligned"},{"color":"#FFD700","text":" troops have regrouped in "},{"bold":false,"text":"$(cityName)","color":"reset",},{"color":"#FFD700","text":"!"}]
$execute if score EntityCount mathCounter = $(cityName) cityConquerValue if score $(cityName) cityOwnership matches 1 run tellraw @a [{"color":"green","bold":false,"text":"Druids"},{"color":"#FFD700","text":" troops have regrouped in "},{"bold":false,"text":"$(cityName)","color":"reset",},{"color":"#FFD700","text":"!"}]
$execute if score EntityCount mathCounter = $(cityName) cityConquerValue if score $(cityName) cityOwnership matches 2 run tellraw @a [{"color":"blue","bold":false,"text":"Royals"},{"color":"#FFD700","text":" troops have regrouped in "},{"bold":false,"text":"$(cityName)","color":"reset",},{"color":"#FFD700","text":"!"}]
