...
# initialize character level for new players (load function fires before player joins, so @a misses them)
execute unless score @s characterLevel matches 1.. run scoreboard players set @s characterLevel 1
execute unless score @s characterXP matches 0.. run scoreboard players set @s characterXP 0
