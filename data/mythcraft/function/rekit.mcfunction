...
item replace entity @s[team=Druids] armor.head with iron_helmet[unbreakable={},enchantments={"minecraft:vanishing_curse":1},enchantment_glint_override=false,trim={material:emerald,pattern:silence}] 1
item replace entity @s[team=Druids] armor.chest with iron_chestplate[unbreakable={},enchantments={"minecraft:vanishing_curse":1},enchantment_glint_override=false,trim={material:emerald,pattern:wild}] 1
item replace entity @s[team=Druids] armor.legs with iron_leggings[unbreakable={},enchantments={"minecraft:vanishing_curse":1},enchantment_glint_override=false,trim={material:emerald,pattern:wild}] 1
item replace entity @s[team=Druids] armor.feet with iron_boots[unbreakable={},enchantments={"minecraft:vanishing_curse":1},enchantment_glint_override=false,trim={material:emerald,pattern:wild}] 1
item replace entity @s[team=Royals] armor.head with iron_helmet[unbreakable={},enchantments={"minecraft:vanishing_curse":1},enchantment_glint_override=false,trim={material:lapis,pattern:silence}] 1
item replace entity @s[team=Royals] armor.chest with iron_chestplate[unbreakable={},enchantments={"minecraft:vanishing_curse":1},enchantment_glint_override=false,trim={material:lapis,pattern:sentry}] 1
item replace entity @s[team=Royals] armor.legs with iron_leggings[unbreakable={},enchantments={"minecraft:vanishing_curse":1},enchantment_glint_override=false,trim={material:lapis,pattern:sentry}] 1
item replace entity @s[team=Royals] armor.feet with iron_boots[unbreakable={},enchantments={"minecraft:vanishing_curse":1},enchantment_glint_override=false,trim={material:lapis,pattern:sentry}] 1
...
item replace entity @s[scores={levelFort-Reference=1..}] weapon.offhand with shield[unbreakable={},enchantments={"minecraft:vanishing_curse":1}] 1

# city benefits (/items at top to make sure nothing is overwritten)
execute if score Amnis cityOwnership matches 1 run item replace entity @s[team=Druids] hotbar.8 with bread[food={nutrition:8,saturation:12.8},consumable={consume_seconds:0.432},enchantments={"minecraft:vanishing_curse":1},custom_name="Nourishing Bread"] 64
execute if score Amnis cityOwnership matches 2 run item replace entity @s[team=Royals] hotbar.8 with bread[food={nutrition:8,saturation:12.8},consumable={consume_seconds:0.432},enchantments={"minecraft:vanishing_curse":1},custom_name="Nourishing Bread"] 64
