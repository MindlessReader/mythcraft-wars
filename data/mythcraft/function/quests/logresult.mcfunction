...
execute if score QuestTracker questWinner matches 1 run data modify storage mythcraft:temp logWinnerColor set from storage mythcraft:config teams.Team1.color
...
execute if score QuestTracker questWinner matches 2 run data modify storage mythcraft:temp logWinnerColor set from storage mythcraft:config teams.Team2.color
execute if score QuestTracker questWinner matches 0 run data modify storage mythcraft:temp logWinner set value "Tie"
execute if score QuestTracker questWinner matches 0 run data modify storage mythcraft:temp logWinnerColor set value "yellow"

# Append structured entry to quest history
