...
execute if score QuestTracker questReward matches 2 run scoreboard players add @a[tag=wonLastQuest] BuffHealthBoost 300
execute if score QuestTracker questReward matches 2 run scoreboard players add @a[tag=wonLastQuest] BuffStrength 300
