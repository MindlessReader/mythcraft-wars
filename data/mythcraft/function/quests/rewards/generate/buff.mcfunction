...
execute if score QuestTracker questReward matches 2 run data modify storage mythcraft:quest rewardText set value "Health Boost II (5:00)"
execute if score QuestTracker questReward matches 2 run data modify storage mythcraft:quest rewardText set value "Strength (5:00)"
