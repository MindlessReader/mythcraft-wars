...
# get slots of all items that need upgrading (try all tiers — last match wins)
data modify storage mythcraft:kit sword set from entity @s Inventory[{id: "minecraft:iron_sword"}].Slot
data modify storage mythcraft:kit sword set from entity @s Inventory[{id: "minecraft:diamond_sword"}].Slot
data modify storage mythcraft:kit sword set from entity @s Inventory[{id: "minecraft:netherite_sword"}].Slot
...
data modify storage mythcraft:kit axe set from entity @s Inventory[{id: "minecraft:diamond_axe"}].Slot
data modify storage mythcraft:kit axe set from entity @s Inventory[{id: "minecraft:netherite_axe"}].Slot
...
data modify storage mythcraft:kit spear set from entity @s Inventory[{id: "minecraft:diamond_spear"}].Slot
data modify storage mythcraft:kit spear set from entity @s Inventory[{id: "minecraft:netherite_spear"}].Slot
...
execute if items entity @s container.* minecraft:diamond_sword run function mythcraft:leveling/items/sword with storage mythcraft:kit
execute if items entity @s container.* minecraft:netherite_sword run function mythcraft:leveling/items/sword with storage mythcraft:kit
...
execute if items entity @s container.* minecraft:diamond_axe run function mythcraft:leveling/items/axe with storage mythcraft:kit
execute if items entity @s container.* minecraft:netherite_axe run function mythcraft:leveling/items/axe with storage mythcraft:kit
...
execute if items entity @s container.* minecraft:diamond_spear run function mythcraft:leveling/items/spear with storage mythcraft:kit
execute if items entity @s container.* minecraft:netherite_spear run function mythcraft:leveling/items/spear with storage mythcraft:kit
