...
# Warrior (class 1)
execute if score @s playerClass matches 1 if score @s characterLevel matches 0 run function mythcraft:leveling/character/applyattributes {armor:8,toughness:0}
...
# Assassin (class 2)
execute if score @s playerClass matches 2 if score @s characterLevel matches 0 run function mythcraft:leveling/character/applyattributes {armor:5,toughness:0}
...
# Bastion (class 3)
execute if score @s playerClass matches 3 if score @s characterLevel matches 0 run function mythcraft:leveling/character/applyattributes {armor:12,toughness:0}
