...
$title @a subtitle [{color:"$(teamColor)",text:"$(teamName)",bold:true},{text:" have slain ",color:"white",bold:false},{text:"$(bossDisplayName)",color:"dark_purple",bold:true},{text:"!",color:"white",bold:false}]
